...
def main():
    ...
    with conn:
        ...
        leave_application_4 = ('4','123', 'nonamefornow','2022/03/01','2022/03/31','PM','sample_reason','application_timestamp','2','APPROVED', 'leave_approved_timestamp');
        leave_application_5 = ('5','Boon Kai', 'nonamefornow','2022/03/01','2022/03/31','PM','sample_reason','application_timestamp','2','APPROVED', 'leave_approved_timestamp');
